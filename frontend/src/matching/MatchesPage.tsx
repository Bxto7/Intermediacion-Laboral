    ...
    <div className="space-y-5">
        ...
        {isLoading ? (
          ...
          <div
            ...
            style={{ background: 'rgba(184,68,42,0.08)', border: '1px solid rgba(184,68,42,0.20)' }}
          >
          ...
          <div className="text-center py-16 space-y-3">
            <div className="w-16 h-16 rounded-3xl mx-auto flex items-center justify-center" style={{ background: 'rgba(42,29,20,0.06)' }}>
