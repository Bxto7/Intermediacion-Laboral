          ...
          <div className="max-w-sm mx-auto w-full space-y-7">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <button key={s.name} className="flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium transition-all" style={{ background: 'white', border: '1px solid rgba(61,40,24,0.15)', color: '#5a3d2b' }}>
                  {s.icon} {s.name}
                </button>
              ))}
            </div>
